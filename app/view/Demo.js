Ext.define("PullMenu.view.Demo", {
    extend: 'Ext.tab.Panel',
    requires: ['Ext.TitleBar', 'PullMenu.view.PullMenuBottomView'],
    xtype: 'main',
